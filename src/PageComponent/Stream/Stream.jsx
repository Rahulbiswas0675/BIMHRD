import './Stream.scss';
import streamImg from '../../Assates/Images/stream.png';

function Stream() {
  return (
    <div className="stream-components">
      <img src={streamImg} alt="streamImg" className="streamImg" />
      <div className="stream-container">
        <div className="stream-item-box">
        ...
        <div className="stream-item-box mid-box">
          <h3 className="title">MBA</h3>
